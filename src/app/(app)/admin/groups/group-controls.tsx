    ...
    <div className="flex flex-col gap-5 rounded-[20px] bg-white shadow-[0_18px_44px_-26px_rgba(30,50,90,.32),0_1px_3px_rgba(30,50,90,.04)] p-6">
      ...
      <div className="flex items-center justify-between border-t border-line-soft pt-4">
        ...
        <button
          ...
          onClick={generate}
          disabled={pending}
          className="font-display cursor-pointer rounded-[9px] bg-[linear-gradient(135deg,#2a63b4,#003E81)] px-6 py-[11px] text-[13.5px] text-white hover:brightness-115 disabled:opacity-60"
        >
