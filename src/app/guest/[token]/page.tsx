...
import { GuestGate, GuestIdentityChip } from "@/components/showcase-client";
  ...
  return (
    <div className="min-h-screen bg-paper">
      <header className="sticky top-0 z-50 border-b border-line bg-white">
        <div className="mx-auto flex w-full max-w-[960px] items-center justify-between gap-2.5 px-4 py-3 sm:px-6">
